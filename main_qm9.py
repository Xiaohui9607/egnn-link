...
model = EGNN(in_node_nf=5, in_edge_nf=0, hidden_nf=args.nf, device=device, n_layers=args.n_layers, coords_weight=1.0,
...
def train(epoch, loader, partition='train'):
    ...
    for i, data in enumerate(loader):
        ...
        nodes = data['one_hot'].to(device, dtype)
        ...
        adj_pred, coords = model.encode(h0=nodes, edges=edges, edge_attr=None, node_mask=atom_mask, edge_mask=edge_mask,
                     n_nodes=n_nodes)

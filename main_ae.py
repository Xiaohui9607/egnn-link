...
parser.add_argument('--dataset', type=str, default='zinc', metavar='N',
...
if args.model == 'ae':
    ...
    if args.dataset == 'qm9':
        ...
        in_n = 1
    model = models.AE_EGNN(in_n=in_n, hidden_nf=args.nf, K=args.K, act_fn=nn.SiLU(), device=device, n_layers=args.n_layers,
